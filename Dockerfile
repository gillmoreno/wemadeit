...
# docker build -t wemadeit .
# docker run -d -p 80:80 -e RAILS_MASTER_KEY=<value from config/master.key> --name wemadeit wemadeit
...
# Ensure storage directory exists with correct ownership for SQLite databases
